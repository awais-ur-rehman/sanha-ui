...
import sanhaLogo from '../assets/logo/SanhaLogo.svg'
  ...
  return (
    <div className="newsletter-template-container">
      <style >{`
        ...
        .hero-section {
          background: linear-gradient(90deg, #F6F4EB 0%, #888969 100%);
          padding: 40px 20px;
          text-align: center;
          color: #000000;
        }
      ...
      <div className="email-container">
        ...
        <div className="footer">
          ...
          <div className="footer-links">
            <a href="#" className="footer-link" style={{ textDecoration: 'none', color: 'black' }}>Contact Us</a> |
            <a href="#" className="footer-link" style={{ textDecoration: 'none', color: 'black' }}>Privacy Policy</a> |
            <a href="#" className="footer-link" style={{ textDecoration: 'none', color: 'black' }}>Manage Preferences</a>
          </div>
        </div>
      </div>
    </div>
