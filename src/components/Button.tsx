...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outlineDanger: 'border border-red-500 text-red-500 hover:bg-red-50 focus:ring-red-500 cursor-pointer bg-white px-10',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 cursor-pointer',
    success: 'bg-[#0c684b] text-white hover:bg-green-700 focus:ring-green-500 cursor-pointer px-10',
