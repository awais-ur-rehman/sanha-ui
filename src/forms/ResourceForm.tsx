...
const createSchema = (category: string) => yup.object({
  ...
  description: (category === 'Articles' || category === 'News' || category === 'Policies' || category === 'Guides')
    ? yup.string().optional()
    ...
    <div className="flex flex-col h-full max-h-[80vh]">
      <form onSubmit={handleSubmit(handleFormSubmit)} className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 p-2">
          ...
          {!(category === 'Articles' || category === 'News' || category === 'Policies' || category === 'Guides') && (
            <Controller
              name="description"
              control={control}
              render={({ field }) => (
                ...
                {(category === 'Articles' || category === 'News' || category === 'Policies' || category === 'Guides') ? (
                  ...
                  watchedImageUrl ? (
                    ...
                    <label
                      ...
                      className={`block w-full border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:border-[#0c684b] hover:bg-gray-50 transition-colors h-[220px] flex flex-col items-center justify-center ${uploadingImage ? 'opacity-50 cursor-not-allowed' : ''
                        }`}
                    >
                  ...
                  <>
                    ...
                    <label
                      htmlFor="image-upload"
                      className={`inline-flex items-center px-3 py-1.5 border border-gray-300 rounded text-[10px] md:text-[11px] lg:text-[11px] xl:text-[12px] font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0c684b] cursor-pointer ${uploadingImage ? 'opacity-50 cursor-not-allowed' : ''
                        }`}
                    >
        ...
        <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200 mt-4 flex-shrink-0 bg-[#F9F8F6]">
          ...
          >
            <span>{isLoading
              ...
              : (category === 'Articles' || category === 'News' || category === 'Policies' || category === 'Guides') ? 'Next' :
      ...
      {/* Rich Text Modal for Articles, News, Policies, and Guides */}
      <RichTextModal
